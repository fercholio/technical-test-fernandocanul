...
namespace Fcanul.TechnicalTest.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //New functionality by fcanul
            if (!ModelState.IsValid)
            {
                return View(model);
            }

            model.Password = PasswordGenerator.EncryptPassword(model.Password);
            var login = await _userService.Get(u => u.Username == model.Email && u.Password == model.Password && u.Enabled && u.Role == Role.Admin);
